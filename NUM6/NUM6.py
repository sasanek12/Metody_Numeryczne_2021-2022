...
def showPlot(arg):
    ...
    fig.set_figheight(6)
    fig.set_figwidth(12)
    axs[0, 0].set_title('Wielomiany interpolacyjne dla funkcji\n' r'$f(x)=\frac{1}{1+25x^2}$ i siatki $x_i=-1+2\frac{i}{n}$')
    ...
    axs[0, 1].set_title('Wielomiany interpolacyjne dla funkcji\n' r'$f(x)=\frac{1}{1+25x^2}$ i siatki $x_i=\cos(\pi\frac{2i+1}{2(n+1)})$')
    ...
    axs[1, 0].set_title('Wielomiany interpolacyjne dla funkcji\n' r'$f(x)=\frac{1}{1+x^2}$ i siatki $x_i=-1+2\frac{i}{n}$')
    ...
    axs[1, 1].set_title('Wielomiany interpolacyjne dla funkcji\n' r'$f(x)=\frac{1}{1+x^2}$ i siatki $x_i=\cos(\pi\frac{2i+1}{2(n+1)})$')
